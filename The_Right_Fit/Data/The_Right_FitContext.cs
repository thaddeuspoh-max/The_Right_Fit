...
{
    public class The_Right_FitContext(DbContextOptions<The_Right_FitContext> options)
        : IdentityDbContext<The_Right_FitUser>(options)
    {
        ...
        // ✅ NEW: persist "Start Plan" selection per user
        public DbSet<The_Right_Fit.Domain.UserActivePlan> UserActivePlan { get; set; } = default!;
